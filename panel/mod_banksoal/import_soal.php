                ...
                <div class='col-md-6'>
                    <form id="formsoalword" action='pages/word_import/import/index.php/word_import' method='post' enctype='multipart/form-data'>
                        <div class='box box-solid'>
                            ...
                            <div class='box-footer'>
                                <a href='pages/word_import/import/sample/contoh_soal_pg.docx'><i class='fa fa-file-word-o'></i> Download Format PG</a>
                                <a href='pages/word_import/import/sample/contoh_soal_pg_esai.docx'><i class='fa fa-file-word-o'></i> Format PG dan ESAI</a>
                                <a href='pages/word_import/import/sample/contoh_soal_esai.docx'><i class='fa fa-file-word-o'></i> Download ESAI</a>
                            </div>
                        </div><!-- /.box -->
                    </form>
                </div>
